...
Vent_Aft_MainPipe_Port_Forward:
    DarkRoom
{
...
// --[NAVIGATION]---------------------------------------------------------------
    fore: TravelWithMessage, RoomConnector {
        ...
        room1 = Vent_Aft_MainPipe_Port_Forward;
        room2 = Vent_Aft_MainPipe_Port_Forward_End;
    };
    ...
    port: TravelWithMessage, RoomConnector {
        ...
        room1 = Vent_Aft_MainPipe_Port_Forward;
        room2 = Vent_Aft_MainPipe_Port_PortFanVent;
    };
// -----------------------------------------------------------------------------
};
